...
// Configuration - Use existing BACKEND_URL as Render backend
const GPU_BACKEND_URL = process.env.NEXT_PUBLIC_GPU_BACKEND_URL || 'https://gpu.smartsuccess.ai';
const RENDER_BACKEND_URL = process.env.NEXT_PUBLIC_RENDER_BACKEND_URL || process.env.NEXT_PUBLIC_BACKEND_URL || 'https://smartsuccess-ai.onrender.com';
